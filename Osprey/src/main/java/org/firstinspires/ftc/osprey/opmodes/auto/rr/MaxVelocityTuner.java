...
import static org.firstinspires.ftc.osprey.subsystems.DrivebaseSubsystem.DriveConstants.TICKS_PER_REV;
import static org.firstinspires.ftc.osprey.subsystems.DrivebaseSubsystem.DriveConstants.WHEEL_RADIUS;
...
public class MaxVelocityTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double effectiveKf = MecanumConstants.getMotorVelocityF(veloInchesToTicks(maxVelocity));
    ...
    private double veloInchesToTicks(double inchesPerSec) {
        return (
            (inchesPerSec /
                ...
                DrivebaseSubsystem.DriveConstants.GEAR_RATIO) *
            TICKS_PER_REV
        );
    }
}
