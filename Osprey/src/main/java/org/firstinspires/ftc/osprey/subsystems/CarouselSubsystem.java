...
import static org.firstinspires.ftc.osprey.subsystems.CarouselSubsystem.CarouselConstants.AUTO_SPEED;
import static org.firstinspires.ftc.osprey.subsystems.CarouselSubsystem.CarouselConstants.CAROUSEL_STOP_SPEED;
import static org.firstinspires.ftc.osprey.subsystems.CarouselSubsystem.CarouselConstants.MAX_SPEED;
import static org.firstinspires.ftc.osprey.subsystems.CarouselSubsystem.CarouselConstants.MIN_SPEED;
...
public class CarouselSubsystem implements Subsystem, Supplier<Double> {
    ...
    public static class CarouselConstants {
        ...
        public static double SPIN_OFFSET = 3.5;
    }
    ...
    public void right() {
        motor.setSpeed(AUTO_SPEED);
    }

    public void right(double speed) {
        motor.setSpeed(MAX_SPEED * Math.max(MIN_SPEED, speed));
    }
