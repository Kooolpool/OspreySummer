...
import static org.firstinspires.ftc.osprey.subsystems.LiftSubsystem.LiftConstants.DEADZONE;
import static org.firstinspires.ftc.osprey.subsystems.LiftSubsystem.LiftConstants.LIFT_LOWER_LIMIT;
import static org.firstinspires.ftc.osprey.subsystems.LiftSubsystem.LiftConstants.LIFT_UPPER_LIMIT;
import static org.firstinspires.ftc.osprey.subsystems.LiftSubsystem.LiftConstants.PID;
...
public class LiftSubsystem implements Subsystem, Supplier<Double> {
    ...
    public static class LiftConstants {
        ...
        public static double COLLECT = 0, NEUTRAL = 150, LEVEL_1 = 100, LEVEL_2 =
            200, TELEOP_LEVEL_2 = 150, LEVEL_3 = 550;
    ...
    public boolean isAtTarget() {
        return (
            Math.abs(
                pidController.getTargetPosition() +
                /*+ because lift is inverted*/liftMotor.getSensorValue()
            ) <
            DEADZONE
        );
    }
