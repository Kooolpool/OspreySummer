...
public class ExtensionSubsystem implements Subsystem, Supplier<String> {
    ...
    public static class ExtensionConstants {
        ...
        public static double IN = 0.46, SHARED = 0.3, TELEOP_ALLIANCE = 0.35, STEAL_SHARED =
            0.2, LOW_GOAL_AUTO = 0, OUT = 0;
        public static double LEFT = 0.1, CENTER = 0.5, RIGHT = 0.9, AUTO_LEFT = 0.25, AUTO_RIGHT =
            0.75;
    }
