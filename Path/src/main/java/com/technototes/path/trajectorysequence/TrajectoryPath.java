...
public interface TrajectoryPath
    extends Function<Function<Pose2d, TrajectorySequenceBuilder>, TrajectorySequence> {
    /**
     ...
     * @return A function that takes a 'start' location and returns a TrajectorySequenceBuilder
     */
    static TrajectoryPath linesToLinearHeadings(
        ConfigurablePoseD start,
        ConfigurablePoseD... points
    ) {
        return b -> {
            TrajectorySequenceBuilder bld = b.apply(start.toPose());
            for (ConfigurablePoseD d : points) {
     ...
     */
    static TrajectoryPath linesToLinearHeadings(
        ConfigurablePose start,
        ConfigurablePose... points
    ) {
        return b -> {
            TrajectorySequenceBuilder bld = b.apply(start.toPose());
            for (ConfigurablePose d : points) {
